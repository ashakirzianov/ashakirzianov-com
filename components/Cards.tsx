...
export function AboutCard({ hue, onHover }: {
    ...
    return <Card>
        <div className="content noselect" unselectable="on">
            —Привет! Меня зовут <span>Анҗан</span>. Я пишу <AboutLink href={href('text', { hue })} highlight="stories" onHover={onHover}>рассказы</AboutLink> и генерирую <AboutLink href={href('art', { hue })} highlight="posters" onHover={onHover}>плакаты и формы</AboutLink>.
            <p>&nbsp;</p>

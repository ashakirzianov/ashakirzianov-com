...
export default function AboutPage() {
    ...
    >
        ...
        <AboutCard>
            ...
            <p>I do <AboutLink href={href('sketch', { hue })}>generative art</AboutLink>. I also write <AboutLink href={href('text', { hue })}>short stories</AboutLink> in Russion. They are fiction, fact-meets-fiction, and everything in-between.</p>
